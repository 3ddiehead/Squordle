...
function App() {
  ...
  return (
    <div>
      <header className="MenuBar">
        ...
        <div className="RightMenu">
          <button type="button" id="settings-button" className="HelpButton">
            ...
            M12,15.6c-1.98,0-3.6-1.62-3.6-3.6 s1.62-3.6,3.6-3.6s3.6,1.62,3.6,3.6S13.98,15.6,12,15.6z">
              </path>
            </svg>
          </button>
        </div>
      ...
      <GSDiv id="gsvar" letterStates={ls_init} rows={gs_init} wordlength={wordlength} validKeys={validKeys} pokemonlist={pokemonlist}/>
    </div>
  );
}
